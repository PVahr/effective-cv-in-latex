...
\newcommand{\myPipe}{\textcolor{lightOrange}{\bfseries|} }  %%%%%%%% \MYPIPE is the command you can use in  the "Core skills" to make a verical pipe
...
\hfill
\begin{minipage}[t]{.47\textwidth}
	%My strong engineering background would be valuable in a hi-tech startups and my enthusiasm for science communication and graphic design would make me .
	\textcolor{lightgray}{
